...
from gestion_presence.api.auth_views import (
    login_view,
    me_view,
...
from gestion_presence.api.seance_views import (
    ...
    delete_academic_filiere,
    update_academic_module,
    delete_academic_module,
...
urlpatterns = [
    ...
    path("seances/academic/filieres/<int:filiere_id>/delete/", delete_academic_filiere, name="delete_academic_filiere"),
    path(
    ...
    path("seances/academic/modules/<int:module_id>/", update_academic_module, name="update_academic_module"),
    path("seances/academic/modules/<int:module_id>/delete/", delete_academic_module, name="delete_academic_module"),
